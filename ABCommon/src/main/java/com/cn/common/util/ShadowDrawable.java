...
public class ShadowDrawable extends Drawable {
    ...
    private ShadowDrawable(int shape, int[] bgColor, int shapeRadius, int shadowColor, int shadowRadius, int offsetX, int offsetY, int type) {
        this.mShape = shape;
    ...
    public void setBounds(int left, int top, int right, int bottom) {
        ...
        if (type == 0) {
            ...
            mRect = new RectF(left, top, right, bottom - mShadowRadius);
        } else {
            mRect = new RectF(left, top - mShadowRadius, right, bottom - mShadowRadius);
        }
    }
    ...
    public static void setShadowDrawableY(View view, int bgColor, int shapeRadius, int shadowColor, int shadowRadius, int type) {
        ShadowDrawable drawable = new ShadowDrawable.Builder()
                .setBgColor(bgColor)
                .setShapeRadius(shapeRadius)
                .setShadowColor(shadowColor)
    ...
    public static class Builder {
        ...
        public ShadowDrawable builder() {
            return new ShadowDrawable(mShape, mBgColor, mShapeRadius, mShadowColor, mShadowRadius, mOffsetX, mOffsetY, type);
        }
    }
}